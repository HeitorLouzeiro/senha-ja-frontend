...
import { Megaphone, Play, UserX } from "lucide-react";
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm">
            ...
            <div className="grid grid-cols-3 gap-3 mt-6">
              ...
              <Button
                ...
                className="flex flex-col items-center justify-center h-20 gap-1.5 bg-blue-600 hover:bg-blue-700 transition-all shadow-md"
              >
